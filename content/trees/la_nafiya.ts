...
export const laNafiyaTree: ExerciseTree = {
  ...
  nodes: {
    ...
    la_built_shape: {
      ...
      hint: "اسم «لا» المفرد في اصطلاح الباب يبنى على ما ينصب به: على الفتح في المفرد وجمع التكسير، وعلى الياء في المثنى وجمع المذكر السالم، وعلى الكسرة في جمع المؤنث السالم؛ وكل ذلك في محل نصب.",
      answers: [
        ...
        { id: "kasra", text: "على الكسرة في محل نصب", next: "R_la_built", eval: { fact: "buildMark", equals: "kasra" }, hint: "إذا كان اسم «لا» جمع مؤنث سالمًا، يبنى على الكسرة لأنه يبنى على ما ينصب به." },
      ],
    },
    la_nasb_shape: {
      id: "la_nasb_shape",
      ...
      hint: "حدد صورة الاسم نفسه قبل العلامة: مفرد، مثنى، جمع مذكر سالم، جمع مؤنث سالم، جمع تكسير، أم من الأسماء الخمسة؟",
      answers: [
        ...
        { id: "jms", text: "جمع مذكر سالم", next: "la_nasb_mark", eval: { fact: "shape", equals: "jms" }, hint: "إذا كان اسم «لا» المعرب جمع مذكر سالم، فعلامة نصبه الياء." },
        { id: "jfs", text: "جمع مؤنث سالم", next: "la_nasb_mark", eval: { fact: "shape", equals: "jfs" }, hint: "جمع المؤنث السالم ينصب بالكسرة نيابة عن الفتحة." },
        { id: "jt", text: "جمع تكسير", next: "la_nasb_mark", eval: { fact: "shape", equals: "jt" }, hint: "جمع التكسير ينصب في الأصل بالفتحة." },
        { id: "five", text: "من الأسماء الخمسة", next: "la_nasb_mark", eval: { fact: "shape", equals: "five" }, hint: "الأسماء الخمسة تنصب بالألف إذا استوفت شروطها، ومع «ذو» تكون بمعنى صاحب، ومع «فو» تكون خالية من الميم." },
      ],
    },
    la_nasb_mark: {
      id: "la_nasb_mark",
      ...
      hint: "الفتحة للمفرد وجمع التكسير، والياء للمثنى وجمع المذكر السالم، والكسرة لجمع المؤنث السالم، والألف للأسماء الخمسة المستوفية للشروط.",
      answers: [
        ...
        { id: "kasra", text: "الكسرة نيابةً عن الفتحة", next: "R_la_nasb", eval: { fact: "nasbMark", equals: "kasra" }, hint: "الكسرة تنوب عن الفتحة في نصب جمع المؤنث السالم." },
        { id: "alif", text: "الألف", next: "R_la_nasb", eval: { fact: "nasbMark", equals: "alif" }, hint: "الألف علامة نصب الأسماء الخمسة إذا استوفت شروطها." },
      ],
    },
