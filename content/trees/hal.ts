...
export const halTree: ExerciseTree = {
  ...
  nodes: {
    hal_relation: {
      ...
      answers: [
        { id: "yes", text: "نعم، تبين الهيئة وتجيب عن «كيف؟»", next: "hal_kind", eval: { fact: "isHal", equals: true }, hint: "ثبت معنى الحال. قبل اختيار النوع حدّد صاحب الحال من المثال: من الذي كان على هذه الهيئة وقت وقوع الفعل؟ ثم انتقل إلى صورة الحال." },
    ...
    hal_kind: {
      id: "hal_kind",
      type: "question",
      context: "ثبتت وظيفة الحال وحددنا صاحب الحال: الاسم الذي كانت له هذه الهيئة وقت وقوع الفعل. نحدد الآن صورة الحال قبل الإعراب النهائي.",
