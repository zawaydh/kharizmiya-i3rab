...
export const cleanKhabarTree: ExerciseTree = {
  ...
  nodes: {
    ...
    khabar_kind: {
      ...
      text: "لنحدد صورة الخبر: هل هو كلمة واحدة، أم جملة كاملة، أم شبه جملة؟",
      hint: "لنتذكر الفرق من المثال نفسه: الخبر المفرد يكون كلمة واحدة تؤدي معنى الخبر مثل: الجندي شجاع أو الكتاب هذا. وخبر الجملة يكون جملة كاملة فيها إسناد، مثل: الطالب يذاكر، أو الطالب أخلاقه حسنة. وخبر شبه الجملة لا يكون كلمة مفردة ولا جملة كاملة، بل جارًا ومجرورًا مثل: الكتاب في الحقيبة، أو ظرفًا مثل: العصفور فوق الشجرة. انظر إلى المحدد: أهو كلمة واحدة؟ أم جملة كاملة؟ أم جار ومجرور أو ظرف؟",
      answers: [
        { id: "a", text: "خبر مفرد: كلمة واحدة أو ما يؤول بمفرد", next: "khabar_single_start", eval: { fact: "khabarKind", equals: "single" }, hint: "الخبر المفرد هنا لا يعني أنه يدل على واحد فقط، بل يعني أنه ليس جملة كاملة ولا شبه جملة. قد يكون كلمة معربة مثل: شجاع، أو مثنى مثل: حاضران، أو جمعًا مثل: مخلصون، أو اسمًا مبنيًا مثل: هو، هذا، الذي، وقد يكون مصدرًا مؤولًا مثل: أن تنجح بمعنى نجاحك." },
    ...
    khabar_single_ending: {
      ...
      hint: "إذا كان صحيح الآخر ظهرت الضمة، وإذا كان معتل الآخر قد تقدر الضمة على آخره.",
      answers: [
