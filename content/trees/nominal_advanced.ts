...
export const nominalAdvancedTree: ExerciseTree = {
  ...
  nodes: {
    ...
    // 3) أول خطوة: نحدد نوع الكلمة الهدف (اسم/فعل/حرف)
    wordType: {
      id: "wordType",
      type: "question",
      text: "أول خطوة: نحدد نوع الكلمة الهدف. ما نوعها؟",
      hint:
    ...
    R_mubtada_sahih: {
      ...
      text:
        ...
        "تلميح: انتبه أن من علامات الاسم يقبل دخول (الـ) وحرف الجر والتنوين.",
    },
    ...
    R_mubtada_moatal: {
      ...
      text:
        ...
        "تلميح: حروف العلة هي الألف والواو والياء؛ هل ينتهي الاسم بأيٍ منها؟",
    },
