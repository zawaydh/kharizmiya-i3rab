...
export const firstWordTree: ExerciseTree = {
  ...
  "nodes": {
    ...
    "R_first_noun": {
      ...
      "type": "result",
      "coverage": "first.noun",
      "text": "عرفت مفتاح الجملة: الكلمة الأولى اسم. راجع باب المبتدأ والخبر لاستكمال تعلّم موقع الاسم وما يتمم معناه في الجملة."
    },
    "R_first_past": {
      "id": "R_first_past",
      "type": "result",
      "coverage": "first.verb.past",
      "text": "عرفت مفتاح الجملة: الكلمة الأولى فعل ماضٍ. راجع باب الفعل الماضي لاستكمال تعلّم أحكامه وعلامات بنائه."
    },
    "R_first_present": {
      "id": "R_first_present",
      "type": "result",
      "coverage": "first.verb.present",
      "text": "عرفت مفتاح الجملة: الكلمة الأولى فعل مضارع. راجع باب الفعل المضارع لاستكمال تعلّم رفعه ونصبه وجزمه وبنائه."
    },
    "R_first_imperative": {
      "id": "R_first_imperative",
      "type": "result",
      "coverage": "first.verb.imperative",
      "text": "عرفت مفتاح الجملة: الكلمة الأولى فعل أمر. راجع باب فعل الأمر لاستكمال تعلّم أحكامه وعلامات بنائه."
    },
    "R_first_particle_verb": {
      "id": "R_first_particle_verb",
      "type": "result",
      "coverage": "first.particle.verb",
      "text": "عرفت مفتاح الجملة: بدأت بحرف وبعده فعل. راجع باب الفعل المضارع لاستكمال تعلّم أثر الأداة في الفعل."
    },
    "R_first_particle_noun": {
      "id": "R_first_particle_noun",
      "type": "result",
      "coverage": "first.particle.noun",
      "text": "عرفت مفتاح الجملة: بدأت بحرف وبعده اسم. في أمثلة حروف الجر تتكوّن شبه جملة؛ راجع باب الخبر لاستكمال تعلّم شبه الجملة والخبر المقدّم."
    }
  }
};
