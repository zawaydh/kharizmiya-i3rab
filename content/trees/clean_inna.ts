...
export const cleanInnaTree: ExerciseTree = {
  ...
  "nodes": {
    ...
    "inna_after_nasikh_effect": {
      ...
      "hint": "بعد دخول الحرف الناسخ تغيّر حكم الاسم الذي بدأنا الحديث عنه. ما الحكم الجديد لهذا الاسم؟",
      "answers": [
        {
          "id": "a",
          "text": "اسم الحرف الناسخ",
    ...
    "inna_after_khabar_effect": {
      ...
      "hint": "بقي هذا الجزء متممًا للمعنى بعد دخول الحرف الناسخ، لكن تغير اسم وظيفته. ما الوظيفة الجديدة؟",
      "answers": [
        {
          "id": "a",
          "text": "اسم الحرف الناسخ",
    ...
    "inna_preposed_shibh_effect": {
      ...
      "hint": "لاحظ ترتيب التركيب: جاء شبه الجملة أولًا ثم اسم نكرة. أيهما أتم المعنى، وأيهما صار الاسم الذي نتحدث عنه؟",
      "answers": [
        {
          "id": "a",
