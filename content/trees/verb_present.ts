...
export const presentVerbTree: ExerciseTree = {
  ...
  nodes: {
    present_step_1: {
      ...
      answers: [
        { id: "a", text: "نعم، نحدد زمن الفعل", next: "present_tense", correct: true },
    ...
    present_has_tool: {
      id: "present_has_tool",
      type: "question",
      context: "عرفنا أن الفعل يحدث الآن أو سيحدث؛ الآن نبحث قبل الفعل عن العامل. (العامل: كلمة تؤثر في إعراب ما بعدها)",
