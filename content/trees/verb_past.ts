  ...
  nodes: {
    past_word_kind: {
      ...
      answers: [
        ...
        { id: "help", text: "أحتاج تلميح", next: "past_word_kind", correct: false, isHelp: true, hint: "اسأل نفسك: هل الكلمة تدل على عمل أو حدث؟ وهل يظهر معها زمن؟ إذا نعم فهي فعل." }
      ]
    },
    ...
    past_tense: {
      ...
      answers: [
        ...
        { id: "help", text: "أحتاج تلميح", next: "past_tense", correct: false, isHelp: true, hint: "إذا كان الحدث قد وقع وانتهى فزمنه ماضٍ. جرّب أن تقول: حدث هذا سابقًا." }
      ]
    },
    ...
    past_has_attachment: {
      ...
      hint: "أسند الفعل إلى الضمير (هو) في الزمن الماضي، ثم قارن بين صورته في الجملة وصورته مع (هو). إذا بقيت الصورة بلا زيادة في الآخر فليس متصلًا به شيء، مثل: قرأَ ← هو قرأَ. وإذا ظهرت زيادة في آخره مثل التاء أو الواو أو الألف أو ضمير النصب فالإجابة نعم، مثل: رجعوا ← هو رجعَ، حفظَهُ ← هو حفظَ.",
      answers: [
        ...
        { id: "help", text: "أحتاج تلميح", next: "past_has_attachment", correct: false, isHelp: true, hint: "أسند الفعل إلى الضمير هو في الزمن الماضي، ثم قارن صورة الفعل في الجملة بصورته مع هو: قرأَ ← هو قرأَ، فلا زيادة في آخره. رجعوا ← هو رجعَ، فهناك واو الجماعة. مشتْ ← هو مشى، وفيها تاء التأنيث وحرف علة محذوف. اختر بحسب المثال أمامك." }
      ]
    },
    ...
    past_no_attachment_weak: {
      ...
      answers: [
        ...
        { id: "help", text: "أحتاج تلميح", next: "past_no_attachment_weak", correct: false, isHelp: true, hint: "انظر إلى آخر حرف في الفعل: هل هو ألف لينة مثل: رمى وسعى؟ أم حرف صحيح تظهر عليه الفتحة مثل: كتبَ وقرأَ؟ انتبه: الهمزة في قرأَ حرف صحيح وليست حرف علة؛ حروف العلة هي الألف والواو والياء." }
      ]
    },
    ...
    past_connector_kind: {
      ...
      hint: "ميّز المتصل من دلالته: ضمير الرفع يضمر الفاعل؛ أي من قام بالفعل. وضمير النصب يضمر المفعول به؛ أي ما وقع عليه الفعل. أما تاء التأنيث الساكنة فليست ضميرًا، بل علامة على أن الفاعل مؤنث.",
      answers: [
        ...
        { id: "help", text: "أحتاج تلميح", next: "past_connector_kind", correct: false, isHelp: true, hint: "اسأل: هل المتصل أضمر من قام بالفعل؟ إذن ضمير رفع. هل أضمر ما وقع عليه الفعل؟ إذن ضمير نصب. هل هو تاء ساكنة لا تدل على الفاعل بل تشير إلى أن الفاعل مؤنث؟ إذن تاء التأنيث الساكنة." }
      ]
    },
    ...
    past_nasb_weak: {
      ...
      answers: [
        ...
        { id: "help", text: "أحتاج تلميح", next: "past_nasb_weak", correct: false, isHelp: true, hint: "احذف ضمير النصب مؤقتًا: كتبَهُ ← كتبَ، رماهُ ← رمى. هل انتهى الأصل بألف لينة؟" }
      ]
    },
    ...
    past_taa_weak: {
      ...
      answers: [
        ...
        { id: "help", text: "أحتاج تلميح", next: "past_taa_weak", correct: false, isHelp: true, hint: "أسند الفعل إلى الضمير هو في الزمن الماضي، ثم قارن: مشتْ ← هو مشى. إذا ظهر في الأصل حرف علة غير موجود في الفعل أمامك فهو محذوف. لا ترجع إلى المضارع هنا." }
      ]
    },
    ...
    past_weak_base_taa: {
      ...
      answers: [
        ...
        { id: "help", text: "أحتاج تلميح", next: "past_weak_base_taa", correct: false, isHelp: true, hint: "ضع قبل الفعل الضمير هو في الزمن الماضي: مشتْ ← هو مشى. وإذا كان مثل بقيتْ فالياء باقية ظاهرة وليست محذوفة." }
      ]
    },
    ...
    past_deleted_letter_taa: {
      ...
      answers: [
        ...
        { id: "help", text: "أحتاج تلميح", next: "past_deleted_letter_taa", correct: false, isHelp: true, hint: "مشتْ ← هو مشى؛ آخر الأصل ألف، وفي مشتْ حُذفت هذه الألف قبل تاء التأنيث. أمّا بقيتْ فليست من مسار الحذف؛ لأن الياء فيها ظاهرة." }
      ]
    },
    ...
    past_raf3_type: {
      ...
      answers: [
        ...
        { id: "help", text: "أحتاج تلميح", next: "past_raf3_type", correct: false, isHelp: true, hint: "انظر إلى آخر الفعل: كتبتُ أو كتبنا أو كتبنَ ← ضمير رفع متحرك يبني على السكون، حضرا/سعيا ← ألف الاثنين، رجعوا/مضَوا/بقُوا ← واو الجماعة، والألف بعدها فارقة لا ألف الاثنين." }
      ]
    },
    ...
    past_sukoon_raf3_type: {
      ...
      answers: [
        ...
        { id: "help", text: "أحتاج تلميح", next: "past_sukoon_raf3_type", correct: false, isHelp: true, hint: "إذا انتهى بتاء: تاء الفاعل. إذا انتهى بـ(نا): نا الفاعلين. إذا انتهى بنون تدل على جماعة الإناث: نون النسوة." }
      ]
    },
    ...
    past_alif_weak: {
      ...
      answers: [
        ...
        { id: "help", text: "أحتاج تلميح", next: "past_alif_weak", correct: false, isHelp: true, hint: "رد الفعل إلى المفرد الغائب في الماضي: حضرا ← حضر، سعيا ← سعى. إن كان أصله مثل سعى فهو فعل ناقص، لكن لا نسلك مسار الحذف هنا." }
      ]
    },
    ...
    past_waw_weak: {
      ...
      context: "",
      text: "هل هناك حرف علة محذوف من آخر الفعل؟",
      hint: "أسند الفعل إلى الضمير هو في الزمن الماضي، ثم قارن: رجعوا ← هو رجعَ: لا حذف. مضَوا ← هو مضى: حُذفت الألف. بقُوا ← هو بقي: حُذفت الياء. إذا كان الأصل ينتهي بألف أو واو أو ياء، وهذا الحرف غير ظاهر في الفعل أمامك، فهو حرف علة محذوف وتكون حركة البناء مقدرة عليه. لا نرجع إلى المضارع؛ لأنه قد يغيّر صورة حرف العلة.",
      answers: [
        ...
        { id: "help", text: "أحتاج تلميح", next: "past_waw_weak", correct: false, isHelp: true, hint: "أسند الفعل إلى الضمير هو في الماضي ثم قارن: رجعوا ← هو رجعَ، مضَوا ← هو مضى، بقُوا ← هو بقي. إذا كان حرف العلة موجودًا في الأصل وغير ظاهر أمامك فهو محذوف. ولا نرجع إلى المضارع." }
      ]
    },
    ...
    past_weak_base_waw: {
      ...
      answers: [
        ...
        { id: "help", text: "أحتاج تلميح", next: "past_weak_base_waw", correct: false, isHelp: true, hint: "ضع هو قبل الفعل في الماضي: مضَوا ← هو مضى، بقُوا ← هو بقي. لا تستعمل المضارع." }
      ]
    },
    ...
    past_deleted_letter_waw: {
      ...
      answers: [
        ...
        { id: "help", text: "أحتاج تلميح", next: "past_deleted_letter_waw", correct: false, isHelp: true, hint: "مضى ← آخره ألف. بقي ← آخره ياء. الحرف الأخير في الأصل هو المحذوف قبل واو الجماعة." }
      ]
    },
