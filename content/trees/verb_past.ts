...
export const pastVerbTree: ExerciseTree = {
    ...
    nodes: {
        ...
        past_has_attachment: {
            ...
            hint: "افصل ما اتصل بآخر الفعل عن أصله: هل توجد تاء، أو نا، أو ألف الاثنين، أو واو الجماعة، أو نون النسوة، أو ضمير نصب؟ لا تعتمد على طول الكلمة وحده.",
            answers: [
                { id: "yes", text: "اتصل بآخره شيء", next: "past_connector_kind", eval: { fact: "hasAttached", equals: true }, hint: "اختر هذا إذا وجدت لاحقة متصلة بعد أصل الفعل، مثل تاء الفاعل أو نا أو ألف الاثنين أو واو الجماعة أو نون النسوة أو ضمير النصب. الدليل هو وجود اللاحقة نفسها، لا مجرد زيادة طول الكلمة." },
                { id: "no", text: "لم يتصل بآخره شيء", next: "past_no_attachment_weak", eval: { fact: "hasAttached", equals: false }, hint: "اختر هذا إذا انتهت الكلمة بأصل الفعل نفسه، ولم تلحقها تاء أو نا أو ألف الاثنين أو واو الجماعة أو نون النسوة أو ضمير نصب." },
            ]
        },
        ...
        past_connector_kind: {
            ...
            answers: [
                { id: "raf3", text: "ضمير رفع يدل على الفاعل", next: "past_raf3_type", eval: { fact: "connectorKind", equals: "raf3" }, hint: "ضمير الرفع يدل على من قام بالفعل. مثل: التاء في كتبتُ، والواو في كتبوا. إن كان المتصل يدل على الشيء الذي وقع عليه الفعل فلا تختر ضمير رفع." },
                { id: "nasb", text: "ضمير نصب يدل على المفعول به", next: "R_past_fatha_nasb", nextByFact: { fact: "weakEnding", map: { "alif_visible": "past_nasb_weak" }, default: "R_past_fatha_nasb" }, eval: { fact: "connectorKind", equals: "nasb" }, hint: "ضمير النصب يدل على ما وقع عليه الفعل، لا على من قام به. مثل الهاء في: قرأهُ الطالبُ؛ الهاء هي الشيء المقروء." },
        ...
        past_raf3_type: {
            ...
            answers: [
                ...
                { id: "alif", text: "ألف الاثنين", next: "R_past_fatha_alif", nextByFact: { fact: "weakOrigin", map: { "true": "R_past_fatha_alif_weak", "false": "R_past_fatha_alif" }, default: "R_past_fatha_alif" }, eval: { fact: "raf3BuildGroup", equals: "alif" }, hint: "ألف الاثنين ضمير متصل يدل على فاعلين اثنين، مثل: حضرا وسعيا. أما الألف في رجعوا فهي ألف فارقة بعد واو الجماعة وليست ألف الاثنين." },
                { id: "waw", text: "واو الجماعة", next: "R_past_damma_waw", nextByFact: { fact: "weakDeleted", map: { "true": "past_waw_weak", "false": "R_past_damma_waw" }, default: "R_past_damma_waw" }, eval: { fact: "raf3BuildGroup", equals: "waw" }, hint: "واو الجماعة تدل على جماعة قاموا بالفعل، مثل: رجعوا. والألف بعدها ألف فارقة لا محل لها، وليست ألف الاثنين." },
            ]
        },
        ...
        past_waw_weak: {
            ...
            answers: [
                { id: "yes", text: "نعم، حُذف حرف علة", next: "past_deleted_letter_waw", eval: { fact: "weakDeleted", equals: true }, hint: "إذا ظهر في الماضي مع هو حرف علة غير موجود قبل واو الجماعة، فهذا الحرف هو المحذوف. مَضَوْا ← هو مضى، بَقُوا ← هو بقي." },
                { id: "no", text: "لا، لم يُحذف حرف علة", next: "R_past_damma_waw", eval: { fact: "weakDeleted", equals: false }, hint: "أسند الفعل إلى هو في الماضي: رجعوا ← هو رجعَ؛ لم يظهر حرف علة في آخر الأصل، إذن لا حذف. أما مَضَوْا ← هو مضى، وبَقُوا ← هو بقي، ففيهما حذف." },
            ]
        },
        past_deleted_letter_waw: {
            ...
            text: "ما حرف العلة المحذوف من آخر الفعل؟",
            hint: "أسند الفعل إلى هو في الماضي: مَضَوْا ← هو مضى، بَقُوا ← هو بقي. مضى تنتهي بألف؛ فالمحذوف ألف. بقي تنتهي بياء؛ فالمحذوف ياء. لا تحكم من المضارع: يبقى.",
            answers: [
        ...
        R_past_weak_waw_alif: {
            ...
            text: "مَضَوْا: فعل ماضٍ مبني على الضم المقدر على الألف المحذوفة لاتصاله بواو الجماعة. وواو الجماعة: ضمير متصل مبني في محل رفع فاعل. والألف: ألف فارقة لا محل لها من الإعراب."
        },
        R_past_weak_waw_yaa: {
            id: "R_past_weak_waw_yaa",
            type: "result",
            coverage: "past.weak_waw_yaa",
            text: "بَقُوا: فعل ماضٍ مبني على الضم المقدر على الياء المحذوفة لاتصاله بواو الجماعة. وواو الجماعة: ضمير متصل مبني في محل رفع فاعل. والألف: ألف فارقة لا محل لها من الإعراب."
        },
        R_past_fatha_alif: {
        ...
        R_past_sukoon_niswa: {
            ...
            text: "جلسنَ: فعل ماضٍ مبني على السكون لاتصاله بضمير رفع متحرك (نون النسوة). ونون النسوة: ضمير متصل مبني على الفتح في محل رفع فاعل."
        },
