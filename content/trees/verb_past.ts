  ...
  nodes: {
    ...
    past_connector_kind: {
      ...
      answers: [
        ...
        { id: "nasb", text: "ضمير نصب يدل على المفعول به", next: "past_nasb_weak", eval: { fact: "connectorKind", equals: "nasb" }, hint: "ضمير النصب يدل على ما وقع عليه الفعل، لا على من قام به. مثل الهاء في: قرأهُ الطالبُ؛ الهاء هي الشيء المقروء." },
    ...
    past_alif_weak: {
      ...
      text: "هل أصل الفعل صحيح الآخر أم معتل الآخر؟",
      ...
      answers: [
        { id: "no", text: "صحيح الآخر", next: "R_past_fatha_alif", eval: { fact: "weakOrigin", equals: false }, hint: "مثل: حضرا أو كتبا؛ أصل الفعل صحيح الآخر، والفعل الماضي مبني على الفتح لاتصاله بألف الاثنين." },
        { id: "yes", text: "معتل الآخر", next: "R_past_fatha_alif_weak", eval: { fact: "weakOrigin", equals: true }, hint: "سعيا أصلها سعى؛ فالأصل معتل الآخر، ومع ذلك يبقى الفعل الماضي مبنيًا على الفتح لاتصاله بألف الاثنين." },
      ]
    },
    ...
    past_weak_base_waw: {
      ...
      text: "ما صورة الفعل الماضي مع الضمير هو؟",
      hint: "لا نرجعه إلى المضارع؛ لأن المضارع قد يغيّر صورة حرف العلة. بَقُوا ← هو بقي، لا: هو يبقى.",
      answers: [
        { id: "mada", text: "هو مضى", next: "past_deleted_letter_waw", eval: { fact: "basePastHuwa", equals: "مضى" }, hint: "صحيح إذا كان الفعل مثل: مَضَوْا؛ أصله مع هو: مضى." },
        { id: "baqiya", text: "هو بقي", next: "past_deleted_letter_waw", eval: { fact: "basePastHuwa", equals: "بقي" }, hint: "صحيح إذا كان الفعل مثل: بَقُوا؛ أصله مع هو: بقي." },
