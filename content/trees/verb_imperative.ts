...
export const imperativeVerbTree: ExerciseTree = {
  ...
  nodes: {
    imperative_pronoun_check: {
      ...
      teaching_note: "لا نسأل هنا: هل هو من الأفعال الخمسة؟ بل نلاحظ الضمير المتصل. إذا اتصل بواو الجماعة أو ياء المخاطبة أو ألف الاثنين فالنون محذوفة من آخره.",
      hint: "استرجع الأصل: اذهبوا ← تذهبون، اذهبي ← تذهبين، اذهبا ← تذهبان. أين النون؟",
      answers: [
    ...
    imperative_weak_check: {
      ...
      teaching_note: "لا تنظر إلى آخر الأمر فقط؛ فقد يكون حرف العلة محذوفًا. أعده إلى أصله لتعرف آخره.",
