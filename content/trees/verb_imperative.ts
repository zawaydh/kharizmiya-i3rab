...
export const imperativeVerbTree: ExerciseTree = {
  ...
  nodes: {
    imperative_pronoun_check: {
      ...
      teaching_note: "، في فعل الأمر لا نقول إنه من الأفعال الخمسة؛ بل نقول: هل اتصل بواو الجماعة أو ياء المخاطبة أو ألف الاثنين؟ إذا نعم فهو مبني على حذف النون من آخره.",
