...
export const cleanKanaTree: ExerciseTree = {
    ...
    "nodes": {
        ...
        "kana_ism_ending": {
            ...
            "hint": "قبل الحكم على آخر الكلمة افصل الضمائر المتصلة، ثم انظر إلى الحرف الأصلي الأخير. وحروف العلة هي: الألف، والواو، والياء. مثل: طموحي = طموح + ياء المتكلم؛ فآخر أصل الاسم حاء صحيحة، والياء ضمير.",
            "answers": [
        ...
        "kana_masdar_site": {
            ...
            "answers": [
                { "id": "ism", "text": "في محل رفع اسم الفعل الناسخ", "next": "R_kana_ism_masdar", "eval": { "fact": "targetRole", "equals": "ism" }, "hint": "إذا كان المصدر المؤول هو صاحب المعنى الذي أسند إليه الخبر بعد الناسخ، فهو في محل رفع اسم الناسخ." },
                { "id": "khabar", "text": "في محل نصب خبر الفعل الناسخ", "next": "R_kana_khabar_single_masdar", "eval": { "fact": "targetRole", "equals": "khabar" }, "hint": "إذا أتم المصدر المؤول المعنى عن اسم الناسخ، فهو في محل نصب خبر الناسخ." }
            ]
        },
