...
export const cleanKanaTree: ExerciseTree = {
  ...
  "nodes": {
    ...
    "kana_connected_pronoun_i3rab": {
      ...
      "hint": "إذا سبق الفعلَ الناسخ اسمٌ ظاهر وعاد عليه ضمير متصل داخل الفعل، فالضمير المتصل هو اسم الناسخ في الإعراب.",
      "answers": [
    ...
    "kana_damir_name": {
      ...
      "hint": "ما دل على متكلم أو مخاطب أو غائب يسمى ضميرًا، ولا نكشف كلمة ضمير قبل هذه الخطوة.",
      "answers": [
