...
export const tawabiExamples: Example[] = [
  ...
  },
  {
    ...
    facts: {
      ...
      linkText: "فاعل (يرفع) ضمير مستتر تقديره (هو) يعود على الخطيب، والهاء في (صوتَهُ) تعود عليه أيضًا",
      relationReason: "لأن جملة يرفع صوته جاءت بعد نكرة وهي خطيب، وفيها رابط يعود على المنعوت: فاعل مستتر تقديره هو يعود على الخطيب، والهاء في صوته تعود عليه أيضًا.",
      finalI3rab: makePhraseFinal("يرفعُ صوتَهُ", "جملة فعلية", "jarr", "خطيبٍ", "اسم مجرور بإلى", "لأنها وصفت خطيبًا نكرة، والرابط هو الفاعل المستتر تقديره هو العائد على الخطيب، والهاء في (صوتَهُ) تعود عليه أيضًا.", "الجملة من الفعل والفاعل المستتر والمفعول به في محل جر نعت.")
    },
