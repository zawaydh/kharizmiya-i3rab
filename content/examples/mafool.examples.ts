...
export const mafoolExamples: Example[] = [
  { id: "mf-01", sentence: "قرأَ الطالبُ الكتابَ.", target: "الكتابَ", facts: { nounKind: "mu3rab", number: "singular", ending: "sahih" }, covers: ["mafool.visible"] },
  { id: "mf-02", sentence: "ساعدَ المعلمُ الفتى.", target: "الفتى", facts: { nounKind: "mu3rab", number: "singular", ending: "moatal" }, covers: ["mafool.estimated"] },
  { id: "mf-03", sentence: "كرّمَ المديرُ الطالبينِ.", target: "الطالبينِ", facts: { nounKind: "mu3rab", number: "dual" }, covers: ["mafool.dual"] },
  { id: "mf-04", sentence: "شكرَ الناسُ المعلمينَ.", target: "المعلمينَ", facts: { nounKind: "mu3rab", number: "jms" }, covers: ["mafool.jms"] },
  { id: "mf-05", sentence: "كرّمتِ المدرسةُ الطالباتِ.", target: "الطالباتِ", facts: { nounKind: "mu3rab", number: "jfs" }, covers: ["mafool.jfs"] },
  { id: "mf-06", sentence: "احترمَ الطالبُ أباكَ.", target: "أباكَ", facts: { nounKind: "mu3rab", number: "five" }, covers: ["mafool.five"] },
  { id: "mf-07", sentence: "إياكَ نعبدُ.", target: "إياكَ", facts: { nounKind: "mabni", mabniType: "damir" }, covers: ["mafool.pronoun"] },
  { id: "mf-08", sentence: "قرأتُ هذا.", target: "هذا", facts: { nounKind: "mabni", mabniType: "ishara" }, covers: ["mafool.ishara"] },
  { id: "mf-09", sentence: "أكرمتُ الذي ساعدني.", target: "الذي", facts: { nounKind: "mabni", mabniType: "mawsool" }, covers: ["mafool.mawsool"] },
  { id: "mf-10", sentence: "أحبُّ أنْ تتعلمَ.", target: "أنْ تتعلمَ", facts: { nounKind: "masdar" }, covers: ["mafool.masdar"] }
];
