...
export const presentVerbCoverageKeysOrdered = [
  ...
  "present.raf3.sahih", "present.raf3.alif", "present.raf3.waw_ya", "present.raf3.five",
  "present.nasb.sahih", "present.nasb.alif", "present.nasb.waw_ya", "present.nasb.five",
  "present.jazm.sahih", "present.jazm.weak", "present.jazm.five"
];
...
export const presentVerbExamples: Example[] = [
  ...
  { id: "pr-04", sentence: "الطلابُ يكتبونَ الدرسَ.", target: "يكتبونَ", facts: { ...base, hasTool: false, tool: "none", attached: "waw" }, covers: ["present.raf3.five"] },
  { id: "pr-05", sentence: "أنتِ تكتبينَ الواجبَ.", target: "تكتبينَ", facts: { ...base, hasTool: false, tool: "none", attached: "yaa" }, covers: ["present.raf3.five"] },
  { id: "pr-06", sentence: "الطالبتان تكتبانِ القصةَ.", target: "تكتبانِ", facts: { ...base, hasTool: false, tool: "none", attached: "alif2" }, covers: ["present.raf3.five"] },
  ...
  { id: "pr-10", sentence: "لن تكتبوا الدرسَ.", target: "تكتبوا", facts: { ...base, hasTool: true, tool: "nasb", attached: "waw" }, covers: ["present.nasb.five"] },
  { id: "pr-11", sentence: "لن تكتبي الدرسَ.", target: "تكتبي", facts: { ...base, hasTool: true, tool: "nasb", attached: "yaa" }, covers: ["present.nasb.five"] },
  { id: "pr-12", sentence: "لن تكتبا الدرسَ.", target: "تكتبا", facts: { ...base, hasTool: true, tool: "nasb", attached: "alif2" }, covers: ["present.nasb.five"] },
  ...
  { id: "pr-15", sentence: "لم تكتبوا الدرسَ.", target: "تكتبوا", facts: { ...base, hasTool: true, tool: "jazm", attached: "waw" }, covers: ["present.jazm.five"] },
  { id: "pr-16", sentence: "لا تهملي واجبَكِ.", target: "تهملي", facts: { ...base, hasTool: true, tool: "jazm", attached: "yaa" }, covers: ["present.jazm.five"] },
  { id: "pr-17", sentence: "لتكتبا الدرسَ.", target: "تكتبا", facts: { ...base, hasTool: true, tool: "jazm", attached: "alif2" }, covers: ["present.jazm.five"] }
];
...
const resultByCover: Record<string, string> = {
  ...
  "present.raf3.five": "فعل مضارع مرفوع وعلامة رفعه ثبوت النون لأنه من الأفعال الخمسة",
  ...
  "present.nasb.five": "فعل مضارع منصوب وعلامة نصبه حذف النون لأنه من الأفعال الخمسة",
  ...
  "present.jazm.five": "فعل مضارع مجزوم وعلامة جزمه حذف النون لأنه من الأفعال الخمسة"
};
...
export const presentVerbQuizExamples = presentVerbExamples.map((ex, i) => {
  ...
  return {
    ...
    whyCorrect: "اتبعنا مسار التفكير: نون النسوة، ثم نون التوكيد، ثم أداة النصب أو الجزم، ثم الأفعال الخمسة، ثم صحيح الآخر أو معتل الآخر عند الحاجة.",
