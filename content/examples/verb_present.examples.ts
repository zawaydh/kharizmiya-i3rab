...
const resultByCover: Record<string, string> = {
  ...
  "present.jazm.sahih": "فعل مضارع مجزوم وعلامة جزمه السكون",
...
export const presentVerbQuizExamples = presentVerbExamples.map((ex, i) => {
  ...
  return {
    ...ex,
    prompt: "ما الإعراب الصحيح للفعل المضارع المحدد؟",
    options,
    correctI3rab: correct,
    whyCorrect: "اتبعنا تسلسل الخوارزمية: بحثنا عن أداة نصب أو جزم، ثم فحصنا الاتصال بواو الجماعة/ياء المخاطبة/ألف الاثنين، ثم حددنا العلامة.",
