...
export const faelExamples: Example[] = [
  { id: "fa-01", sentence: "كتبَ الطالبُ الدرسَ.", target: "الطالبُ", facts: { nounKind: "mu3rab", number: "singular", ending: "sahih" }, covers: ["fael.visible"] },
  { id: "fa-02", sentence: "حضرَ الفتى مبكرًا.", target: "الفتى", facts: { nounKind: "mu3rab", number: "singular", ending: "moatal" }, covers: ["fael.estimated"] },
  { id: "fa-03", sentence: "فازَ الطالبانِ.", target: "الطالبانِ", facts: { nounKind: "mu3rab", number: "dual" }, covers: ["fael.dual"] },
  { id: "fa-04", sentence: "اجتهدَ المعلمونَ.", target: "المعلمونَ", facts: { nounKind: "mu3rab", number: "jms" }, covers: ["fael.jms"] },
  { id: "fa-05", sentence: "نجحتِ الطالباتُ.", target: "الطالباتُ", facts: { nounKind: "mu3rab", number: "jfs" }, covers: ["fael.jfs"] },
  { id: "fa-06", sentence: "حضرَ أبوكَ.", target: "أبوكَ", facts: { nounKind: "mu3rab", number: "five" }, covers: ["fael.five"] },
  { id: "fa-07", sentence: "حضرَ هوَ.", target: "هوَ", facts: { nounKind: "mabni", mabniType: "damir" }, covers: ["fael.pronoun"] },
  { id: "fa-08", sentence: "نجحَ هذا.", target: "هذا", facts: { nounKind: "mabni", mabniType: "ishara" }, covers: ["fael.ishara"] },
  { id: "fa-09", sentence: "فازَ الذي اجتهدَ.", target: "الذي", facts: { nounKind: "mabni", mabniType: "mawsool" }, covers: ["fael.mawsool"] },
  { id: "fa-10", sentence: "يسرُّني أنْ تنجحَ.", target: "أنْ تنجحَ", facts: { nounKind: "masdar" }, covers: ["fael.masdar"] }
];
