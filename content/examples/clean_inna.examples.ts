...
export const cleanInnaQuizExamples = [
  ...
  },
  {
    ...
    "whyCorrect": "«ذو»: نحدد أولًا أهي اسم الحرف الناسخ أم خبره، ثم نحدد صورتها، وبعد ذلك نختار العلامة أو المحل الإعرابي.",
    "optionReasons": {
      ...
      "خبر إن مرفوع وعلامة رفعه الواو لأنه من الأسماء الخمسة": "صحيح؛ «ذو» خبر إن مرفوع وعلامة رفعه الواو لأنه من الأسماء الخمسة."
    }
  },
  {
    "id": "in-18",
  ...
  },
  {
    ...
    "optionReasons": {
      ...
      "خبر أن مرفوع وعلامة رفعه الضمة الظاهرة على آخره": "خطأ؛ الاختيار لا يطابق وظيفة «أن تنجحَ» ولا صورتها. ابدأ بتحديد موقعها بعد الحرف الناسخ، ثم اختر العلامة المناسبة.",
      "مصدر مؤول في محل رفع خبر أن": "صحيح؛ «أن تنجحَ» مصدر مؤول في محل رفع خبر أن."
    }
  },
  {
    "id": "in-22",
