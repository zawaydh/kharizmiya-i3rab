...
import { presentVerbExamples, presentVerbLearnExamples, presentVerbPracticeExamples, presentVerbCoverageKeysOrdered, presentVerbQuizExamples } from "../content/examples/verb_present.examples";
...
export const TOPICS = [
  ...
  },
  {
    ...
    shortLabel: "المضارع",
    desc: "خوارزمية المضارع بالتسلسل التعليمي المعتمد: نبدأ بنون النسوة ثم نون التوكيد، ثم نفحص الناصب أو الجازم، ثم الأفعال الخمسة وهي الأفعال المضارعة التي اتصلت بياء المخاطبة أو ألف الاثنين أو واو الجماعة، ثم نحدد صحيح الآخر أو معتل الآخر عند الحاجة.",
    tree: presentVerbTree,
    examples: presentVerbExamples,
    learnExamples: presentVerbLearnExamples,
    practiceExamples: presentVerbPracticeExamples,
