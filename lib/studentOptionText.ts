const EXACT_STUDENT_LABELS: Record<string, string> = {
  "tawabi.naat": "النعت",
  "tawabi.atf": "العطف",
...
export function containsArabicText(value: unknown) {
  return /[\u0600-\u06FF]/.test(String(value || ""));
}

export function looksLikeProgrammingOption(value: unknown) {
...
export function toStudentArabicOption(value: unknown, fallback = "الخيار النحوي المناسب") {
