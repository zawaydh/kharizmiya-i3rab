      ...
      <section className="card auth-modern-hero card-glow">
        <div className="auth-modern-copy">
          ...
          <div className="auth-purpose-note" role="note" aria-label="سبب التسجيل">
            ...
            <p>يمكنك التعلّم الموجّه كزائر دون حساب. سجّل الدخول لحفظ تقدمك، والوصول إلى التدريب والاختبار النهائي، ومعرفة المرحلة التي وصلتَ إليها وعرض إنجازك بوضوح في لوحتك.</p>
          </div>
