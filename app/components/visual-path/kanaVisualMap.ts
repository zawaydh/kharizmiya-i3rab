...
export function buildKanaVisualMap(example: Example | null): VisualMap {
  ...
  addResult(nodes, "kana:result:ism:five", "اسم الناسخ مرفوع\nوعلامة رفعه الواو", "اسم الفعل الناسخ مرفوع، وعلامة رفعه الواو؛ لأنه من الأسماء الخمسة وقد استوفى شروط الإعراب بالحروف: مفرد، مكبر، مضاف، ومضاف إلى غير ياء المتكلم.");
  ...
  addResult(nodes, "kana:result:khabar:five", "خبر الناسخ منصوب\nوعلامة نصبه الألف", "خبر الفعل الناسخ منصوب، وعلامة نصبه الألف؛ لأنه من الأسماء الخمسة وقد استوفى شروط الإعراب بالحروف: مفرد، مكبر، مضاف، ومضاف إلى غير ياء المتكلم.");
