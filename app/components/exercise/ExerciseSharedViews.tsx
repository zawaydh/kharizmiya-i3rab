...
export const SMART_GLOSSARY: Record<string, GlossaryEntry> = {
  // QARINA_GLOSSARY_V18B
  "قرينة": { title: "القرينة", body: ["تعني هنا: دليلك؛ أي العلامة أو المعلومة في المثال التي تساعدك على اتخاذ القرار النحوي الصحيح."] },
  "قرينتك": { title: "القرينة", body: ["تعني هنا: دليلك؛ أي العلامة أو المعلومة في المثال التي تساعدك على اتخاذ القرار النحوي الصحيح."] },
  "العامل": { title: "العامل", body: ["كلمة أو أداة أو علاقة نحوية تؤثر في حكم كلمة أخرى، مثل «لن» التي تنصب المضارع، و«لم» التي تجزمه، وحرف الجر الذي يجر الاسم بعده.", "لا يكفي وجود كلمة قبل المطلوب؛ نحدد هل لها أثر نحوي فيه أم لا."] },
  "المحل الإعرابي": { title: "المحل الإعرابي", body: ["الموقع الإعرابي الذي تشغله كلمة مبنية أو جملة أو شبه جملة، مثل محل رفع أو نصب أو جر، ويكون للفعل المضارع المبني محل رفع أو نصب أو جزم بحسب العامل.", "نفرّق بين علامة البناء مثل الفتح أو السكون، وبين المحل الذي تحدده الوظيفة أو العامل."] },
  "مبني": { title: "المبني", body: ["يلزم صورة واحدة ولا يتغير آخره بتغير موقعه الإعرابي.", "نذكر علامة بنائه، وإذا كان له موقع في الجملة نذكر محله الإعرابي أيضًا."] },
  "معرب": { title: "المعرب", body: ["يتغير آخره بحسب موقعه أو العامل المؤثر فيه: رفعًا أو نصبًا أو جرًا أو جزمًا بحسب نوع الكلمة.", "بعد معرفة الوظيفة نحدد العلامة المناسبة من صورة الكلمة."] },
  "ظرف": { title: "الظرف", body: ["اسم يدل على زمان وقوع الحدث أو مكانه، ويجيب غالبًا عن: متى؟ أو أين؟", "من الظروف الواردة في أمثلة المشروع: ليلًا، أمامَ، فوقَ، عند، عندنا، غدًا.", "إذا استُعمل الظرف مع ما يتمم معناه فقد يكوّن شبه جملة، ويحدد موقع شبه الجملة من السياق."] },
  "لا النافية للجنس": { title: "لا النافية للجنس", body: ["تنفي الحكم عن جميع أفراد الجنس، وتعمل عمل إنَّ إذا استوفت شروطها: تنصب اسمها وترفع خبرها.", "اسمها قد يكون مفردًا، أو مضافًا، أو شبيهًا بالمضاف. والمفرد هنا يعني: غير المضاف وغير الشبيه بالمضاف.", "نثبت نوع اسم لا أولًا، ثم نحدد صورته الإعرابية وعلامة نصبه."] },
  "المضاف": { title: "المضاف", body: ["اسم ارتبط باسم أو ضمير بعده ليتم معناه، ويأتي بعده مضاف إليه مجرور أو في محل جر.", "مثال مستقل: كتابُ الطالبِ؛ «كتاب» مضاف و«الطالب» مضاف إليه.", "في المنادى واسم لا النافية للجنس يُستفاد من وجود الإضافة لتحديد النوع."] },
  "الشبيه بالمضاف": { title: "الشبيه بالمضاف", body: ["اسم اتصل به ما يتمم معناه، لكنه ليس مضافًا إلى اسم بعده إضافة حقيقية.", "مثل: يا طالبًا علمًا؛ «طالبًا» تم معناه بما بعده، لكنه ليس تركيب إضافة من نوع «طالب العلم».", "في باب لا النافية للجنس والمنادى نميّزه عن المضاف والمفرد من العلاقة بما بعده."] },
  "مفرد علم": { title: "المنادى المفرد العلم", body: ["اسم علم يُنادى به شخص أو مكان معيّن باسمه، مثل: يا محمدُ.", "نتعرف إلى الخاصية أولًا: هل الاسم علم لشخص معيّن؟ ثم نستخدم المصطلح."] },
  "نكرة مقصودة": { title: "النكرة المقصودة", body: ["نكرة يقصد بها عند النداء شخص معيّن حاضر أو معلوم، مثل: يا طالبُ، وأنت تقصد طالبًا بعينه."] },
  "نكرة غير مقصودة": { title: "النكرة غير المقصودة", body: ["نكرة لا يقصد بها فرد بعينه، مثل: يا طالبًا، خذ بيدي؛ أي أيَّ طالب."] },
  ...
  "واو الجماعة": { title: "واو الجماعة", body: ["ضمير متصل يدل على جماعة الذكور.", "يكون في محل رفع، وتحدد وظيفته من بناء الفعل والسياق؛ فقد يكون فاعلًا أو نائب فاعل أو اسمًا لفعل ناسخ."] },
  "ألف الاثنين": { title: "ألف الاثنين", body: ["ضمير متصل يدل على مثنى.", "يكون في محل رفع، وتحدد وظيفته من بناء الفعل والسياق؛ فقد يكون فاعلًا أو نائب فاعل أو اسمًا لفعل ناسخ."] },
  "ياء المخاطبة": { title: "ياء المخاطبة", body: ["ضمير متصل يدل على المخاطبة المؤنثة.", "مع المضارع والأمر تكون في محل رفع، وتحدد وظيفتها من الفعل والسياق؛ وتكون فاعلًا في الأمثلة المبنية للمعلوم التي يسند فيها الفعل إلى المخاطبة."] },
  ...
  "شبه جملة": { title: "شبه الجملة", body: ["جار ومجرور أو ظرف.", "يحدد موقعها من السياق؛ فقد تأتي خبرًا أو نعتًا أو حالًا، أو تتعلق بعامل آخر بحسب معنى الجملة."] },
