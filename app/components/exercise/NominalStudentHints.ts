    ...
    if (id.includes("mubtada")) {
        ...
        if (id === "mubtada_number") {
            ...
            if (pickedText.includes("الأسماء الخمسة"))
                return `الأسماء الخمسة هي: أب، أخ، حم، فو، ذو بمعنى صاحب. ولا تعرب بالحروف إلا بشروط: أن تكون مفردة، مضافة، غير مضافة إلى ياء المتكلم، وأن تكون (ذو) بمعنى صاحب. هل (${currentTarget}) واحد منها وتحققت شروطه؟`;
        ...
        if (id === "khabar_kind") {
            if (pickedText.includes("مفرد")) {
                if (sentence.includes("الذي"))
                    return "(الذي) اسم موصول مفرد؛ أما (خلقنا) فهي صلة الموصول. لذلك لا نجعل الخبر جملة هنا، بل ننظر إلى الاسم الموصول نفسه.";
            ...
            if (pickedText.includes("جملة"))
                return "الخبر الجملة يكون تركيبًا فيه إسناد كامل، مثل: أخلاقه حسنة، أو يستقبل الضيوف. أما الاسم الموصول وحده مثل (الذي) فليس جملة؛ وما بعده صلة موصول.";
            if (pickedText.includes("شبه"))
                return "شبه الجملة يكون جارًا ومجرورًا مثل (في البيت)، أو ظرفًا مثل (فوق الشجرة). إذا كان عندك كلمة واحدة أو جملة كاملة فليست شبه جملة.";
        }
